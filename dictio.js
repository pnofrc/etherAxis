...
var narration = [
    'This is the text from sickhouse to smartshop',
    'This is the text from smartshop to training station',
    'This is the text from training to archive',
    'This is the text from archive to shrooms',
    'This is the text from shroom to sickhouse',
]

var qq = [
    'Picture the perfect tool in your hand, is it electronic?',
    'Would like being able to reach reach everything by foot?',
    'If you collected an archive of your life, would it fit in the cloud or in your hands?',
    'Have you ever felt the radio active static as part of your aura?',
...
var rid = [
    ...
    'Transmitter! The bridge point to your realm is centered around a big tree on a crossing. At its feet, there is a lucious polypore fungus. Draw a line from this tree to the closest fence in your mind. This is where you will find a tiny magnetic container hidden next to a screw. Put it back as you found it after',
