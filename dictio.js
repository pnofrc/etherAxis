...
var coord = [ //lat, lng, n on paper map
    [52.22155876311503, 6.893062607042662, "Bridge point n. 19"],
    [52.22382044607462, 6.891231307205406, "Bridge point n. 18"],
    [52.22382044607462, 6.891231307205406, "Bridge point n. 20"],
    [52.22276670038885, 6.888961243923923, "Bridge point n. 17"],
    [52.22199455297122, 6.891917407847092, "Return to the center point."]
];
...
var qq = [
    ...
    "Hello Sychroniser. How did it make you feel? To move with us, and just like us. I could feel you. I felt you shaking, but just a little bit. Like a single drop of water falling into a larger body of its liquid. Empty spaces in the human world like here are great for us, because the vibrations of energy that travel through these walls and tiles are less distracted by passing figures. It’s important that enough of these locations remain because we need them to sense the essential changes in the Ether. This one here is actually one of our favourites, and it's in danger for it might be destroyed. You can feel the frustration in the people around you. What will you do? Remember your skills and nature.",

    "Welcome Energizer. They are as resourceful as emotional, the array of messages we receive on our ongoing journeys. But your message must be one of our favourites. The messages we receive kind of sound like the waves you're hearing right now. We know you’re a bit scared but don’t worry, we are too. It's what makes us strong. As you move on to the next location, you suddenly see a small path that leads away from the main road. You’re actually in a hurry, but maybe this route could be quicker and gosh the fragrance that penetrates your nose is beautifully strong. It’s like your body is drawn to it, but maybe it’s just distraction or your body is tired. What do you do? Remember your skills and nature.",

    "Welcome transmitter, you are my personal favourite. The interconnectedness of all beings is what binds the alternate realities of the Ether together. Without our knowledge there would only be chaos. Without knowledge of transformation, we wouldn’t know how to adapt to it. There is something that binds all of your journeys together. There is something in the shapes of your movements and flows of energy creating a pattern. It’s as if a new kind of language formed a secret code, you just don't know how to read it yet. What do you do? Remember your skills and nature.",
...
var instru = [
    '',
    'Your reality is layered, Sychronizer. So much so, that it has been blocking your view of the ether. Peel back the different layers of perception by moving the device to reveal the hidden layers. Tap the buttons until all you see is the core. Your cryptic motion skill is needed here.',
    'The voices of the ancients are not far from your reach, Energizer. Your lucid echo allows you to channel their same waves. Record a message, speaking directly to the interconnected archive of experiences. You are able to share how you are experiencing the current changes in your world with the ancients.',
    'Transmitter, you have found the space where the vast network of your realm spills over into another. Connect to the network coming from the tree to link up the network of your mind with the one of the polypore.',
    ''
]
